...
export default class PlayButton extends cc.Component {
    ...
    start(){
        ...
        if(n == 0)
        {
            ...
            tower.push(new LocalTowerMessege(1,"ARROW",true,2))
            tower.push(new LocalTowerMessege(2,"KITTY LITTER",true,1))
            tower.push(new LocalTowerMessege(3,"YARN",true,1))
            tower.push(new LocalTowerMessege(4,"MAGIC",true,1))
            tower.push(new LocalTowerMessege(5,"FIRE",true,1))
            tower.push(new LocalTowerMessege(6,"LASER",true,1))
            ...
            localStorage.setItem("max_maplv",String(0));
